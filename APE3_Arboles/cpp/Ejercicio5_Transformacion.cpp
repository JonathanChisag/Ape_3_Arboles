...
Nodo* invertir(Nodo* raiz) {
    ...
    // SOLUCIÓN: Guardamos el hijo izquierdo en temporal, luego asignamos a la izquierda
    // la versión invertida del subárbol derecho, y a la derecha la del temporal.
    // El proceso se repite recursivamente hasta llegar a nodos hoja.
