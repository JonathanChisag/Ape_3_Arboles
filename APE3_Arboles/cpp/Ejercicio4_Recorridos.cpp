...
void inOrderAux(Nodo* nodo, vector<int>& resultado) {
    ...
    // SOLUCIÓN: Recorrido In-Order: primero subárbol izquierdo, luego el nodo actual,
    // luego subárbol derecho. Esto produce los valores en orden ascendente en un BST.
