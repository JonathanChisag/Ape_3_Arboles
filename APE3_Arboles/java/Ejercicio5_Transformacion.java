public class Ejercicio5_Transformacion {
    public static Nodo invertir(Nodo raiz) {
        ...
        // SOLUCIÓN: Guardamos el hijo izquierdo en temporal, asignamos a la izquierda
        // la versión invertida del derecho, y al derecho la del temporal.
        // Se repite recursivamente hasta los nodos hoja.
